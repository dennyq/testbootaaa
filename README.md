...
========================================================================================================================
GRUNT INITAIL SETTING
========================================================================================================================
0. jetbrain사 IDE 터미널 접속
alt+F12

1. Grunt CLI 설치(이미 설치되었으면 skip)
$ npm install -g grunt-cli

2. Grunt 설치(현재 프로젝트 폴더에서)
$ npm install grunt --save-dev

3. package.json 파일 생성
$ npm init(현재 프로젝트 폴더에서)

4. Gruntfile.js 파일 생성(되어있음)

5. 사용을 원하는 Grunt Plugin 설치(한개씩...)
$ npm install --save-dev time-grunt
$ npm install --save-dev load-grunt-tasks
$ npm install --save-dev grunt-conrib-concat 
...


* 한방설치 npm install --save-dev
...
#(application.properties 사용하는 부분만 설정)
...
# ----------------------------------------
# GRADLE TASK SCP SETTING 출처
# ----------------------------------------


https://github.com/jojoldu/blog-code/tree/master/gradle-task
