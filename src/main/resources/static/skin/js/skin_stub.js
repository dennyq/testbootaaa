...
function __GetPlaySrc()		{ return parent.video_getplaysrc(); }
function __GetPlayVideo()		{ return parent.video_getplayvideo(); }
...
function __GetTime()			{ return parent.video_gettime(); }
...
function __RepeatSetleft(x)		{	parent.video_repeatleft(x);}
function __RepeatSetright(x)	{	parent.video_repeatright(x);}
...
function __FullscreenToggle(isFull)			{	parent.video_fullscreen_toggle(isFull); 		}

function __FastReverse()		{   parent.video_fastreverse(); 	}
function __FastForward()		{   parent.video_fastforward(); 	}
function __SkipToMove(time)		{   parent.video_skip(time); 	}
...
function __RepeatDraging(x)	{	 parent.video_repeatdraging();}
...
//todo: track HIDDEN, SHOW
function __TrackHide()		{	parent.video_trackhide(); 	}
function __TrackShow(lang)		{	parent.video_trackshow(lang); 	}
function __TrackChange(lang)		{	parent.video_trackchange(lang); 	}
//function __TrackMode()		{	return parent.video_trackmode(); 	}
function __TrackInfo()		{	return parent.video_trackinfo(); 	}