...
function video_resize() {
	...
	console.log('__player_id : ' + __player_id);
	//$("#player_video").width ( $("#player_div").width() );
	//$("#player_video").height ( $("#player_div").height()- __player_skinheight );
	...
	if(isIE){
		...
		console.log('h2 : ' + $("#player_video").height());//

		console.log($("#player_video").height() == h - 260);//
		console.log($("#player_video").height() == h - 130);//
		...
		console.log('this__full_height!!! : ' + this__full_height);
		if (isFullScreen &&
			getCookie('__ori_height') <= $("#player_video").height() &&
			h <= $("#player_video").height()
		) {
			console.log('!!!!!!!' + $("#player_video").height());
			$("#player_video").height(getCookie('__ori_height'));
			...
			// $("#player_video").height(getCookie('__ori_height')- __player_skinheight );
		}

		if (document.getElementById('renameSubHeaderForm') != null) {
			console.log('exfull??!!!!!!!' + $("#player_video").height());
			//$("#player_video").height(getCookie('__ori_height'));
		}

		if (hasFull && $("#player_video").height() != __ori_height && $("#player_video").height() == this__full_height) {
			console.log('aaaa');
			$("#player_video").height(__ori_height);
			if (isFullScreen == true) {
				isFullScreen = false;
				console.log('1111getCookie : ' + getCookie('__ori_height'));
