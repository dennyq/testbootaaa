...
//    String src = "http://auth.mediacast.co.kr/mov/demo.mp4";
...
<head>
    ...
    <script language="javascript" src="/skin/js/jquery.cookie.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $(function(){
        var option = {
            ...
            'skinType'		: 'newskin2',  			//스킨타입
            <%--'src'			: '${src}',		    //file위치+file명--%>
//            'src'			: 'http://192.168.0.25/mov/demo.mp4',	    //file위치+file명
            'src'			: 'http://localhost/mov/demo.mp4',	    //file위치+file명
//            'src'			: 'http://auth.mediacast.co.kr/free/demo.mp4',	    //file위치+file명
            <%--'src'			: '<%=src%>',	    //file위치+file명--%>
            'token'         : '<%=token%>',
//            'posterImage'	: 'http://192.168.0.25/skin/advance/images/sample/sample_movie_10.jpg',		    //file위치+file명
            ...
            'continuity'	: 'Y',  					//이어보기
            'continuityAlert'	: 'N',  					//이어보기
            <%--'lastPosition'	: '${lastPosition}', 					//이어보기 위치--%>
//            'lastPosition'	: '30', 					//이어보기 위치
            'userId'		: '${userId}',		//유저아이디
            ...
            //자막설정
            "subtitle": {
                "on": 'Y',src:[{"lang": 'ko', "url": 'http://localhost/free/dragonball.vtt'},{"lang": 'en', "url": 'http://localhost/free/sintel-en.vtt'}]
//                "src":[
//                    {"lang": 'ko', "url": 'http://localhost/free/dragonball.vtt'},
//                    {"lang": 'en', "url": 'http://localhost/free/sintel-en.vtt'},
////                    {"lang": 'ko', "url": 'http://localhost/free/dragonball.vtt'},
////                    {"lang": 'ko', "url": 'http://localhost/free/dragonball.vtt'},
//
//                ]
